...
#' 75 respondents in each group. In cell 1 product VSX123 was presented first
#' and then SDF546. In cell 2 sweets were presented in reversed order. There are
#' screening questions at the beginning of the questionnaire.  Questions about
#' respondent impressions about first product are in the block A (and about
#' second tested product in the block B). At the end of the questionnaire  there
#' are questions about preferences between sweets.
#'    
#' 
