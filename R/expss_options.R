...
#' \item{\code{expss.enable_value_labels_support} }{By default, all labelled variables 
#' will use labels as labels for factor levels when \link{factor} is called. So 
#' any function which calls \link{factor}/\link{as.factor} will use value 
#' labels. If you have compatibility problems set this option to zero: 
#' \code{options(expss.enable_value_labels_support = 0)}.}
