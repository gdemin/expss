...
")
  ...
  #################################################
  cat("fre and cro some special cases", "
")
...
")
  ...
  expect_equal_to_reference(cross_sum(sheet(a, b), a, list(b, total())), 
  ...
  expect_equal_to_reference(cross_median(sheet(a, b), b, list(a, total())), "rds/cro_median2.rds")
  ...
  expect_equal_to_reference(cross_median(iris, ..[!perl("Species")], list(Species, total())), 
  ...
  expect_equal_to_reference(cross_sum(iris, ..[!perl("Species")], list(Species, total())), 
