...
if(isTRUE(getOption("covr")) && dir.exists("data_files")){
    ...
    expect_equal_to_reference(res, "rds/write_labelled_csv1.rds")
    unlink("mtcars.csv")
    write_labelled_tab(mtcars, "mtcars.tab", single_file = FALSE)
    dat = readLines("mtcars.tab")
    dic= readLines("mtcars.dic.tab")
    expect_equal_to_reference(dat, "rds/write_labelled_tab.rds")
    expect_equal_to_reference(dic, "rds/write_labelled_dic_tab.rds")
    ...
    res = readLines("mtcars.csv")
    expect_equal_to_reference(res, "rds/write_labelled_csv2_quoted.rds")
    ...
    dat = readLines("mtcars.tab")
    dic= readLines("mtcars.dic.tab")
    expect_equal_to_reference(dat, "rds/write_labelled_tab2.rds")
    expect_equal_to_reference(dic, "rds/write_labelled_dic_tab2.rds")
    ...
    # expect_equal_to_reference(data, "rds/old_write_labelled_data.rds")
    # expect_equal_to_reference(dic, "rds/old_write_labelled_dic.rds")
