...
expect_equal_to_reference(
    significance_cpct(mtcars_table, keep_numbers = FALSE),
    "rds/signif_cpct1.rds")
expect_equal_to_reference(
    significance_cpct(mtcars_table, keep_numbers = FALSE, na_as_zero = TRUE),
...
#####################
expect_equal_to_reference(
    significance_cpct(mtcars_table, keep_numbers = FALSE, keep_bases = TRUE),
    "rds/signif_cpct10.rds")

expect_equal_to_reference(
    significance_cpct(mtcars_table, keep_numbers = TRUE),
    "rds/signif_cpct11.rds")

expect_equal_to_reference(
    significance_cpct(mtcars_table, keep_numbers = TRUE, keep_bases = FALSE),
...
expect_equal_to_reference(
    significance_cpct(mtcars_table3, keep_numbers = FALSE),
    "rds/signif_cpct1a.rds")

expect_equal_to_reference(
    significance_cpct(mtcars_table3, keep_numbers = FALSE, sig_labels = "a"),
