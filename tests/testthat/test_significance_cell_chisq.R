...
" 5.26 -", "10.53 -", "10.53  ", "21.05 +", "52.63 +")), row.names = c(NA, 
 -6L), class = c("etable", "data.frame"))
expect_identical(significance_cell_chisq(test_table, sig_labels = c("-", "+")), res)
expect_identical(significance_cell_chisq(test_table, sig_labels = c("-", "+"), subtable_marks = "both"), res)
